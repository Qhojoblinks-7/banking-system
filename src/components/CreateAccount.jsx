...
const CreateAccount = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showAlert('Registration successful! Redirecting to your account overview...', 'bg-green-100 text-green-700');
      setTimeout(() => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (error || !data) {
        ...
        showAlert('Login successful! Redirecting to your account overview...', 'bg-green-100 text-green-700');
        setTimeout(() => {
          navigate('/user-account-overview');
        }, 2000);
      }
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-sky-50 font-sans p-4 relative">
      ...
      {isSignup ? (
        <div className="w-full max-w-md mx-auto gradient-border shadow-lg bg-white p-6">
          ...
          {alert.visible && (
            <div className={`mt-4 p-3 rounded text-center ${alert.classes}`}>{alert.message}</div>
          )}
          ...
          <div className="mb-4">
            <div className="progress-container bg-gray-200 rounded-full overflow-hidden">
              <div
                className="progress-bar h-1 bg-gradient-to-r from-blue-400 via-blue-300 to-green-400"
        ...
        <div className="w-full max-w-md mx-auto gradient-border shadow-lg bg-white p-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label htmlFor="loginUsername" className="block text-gray-700 font-medium mb-1">Username:</label>
              <input
                type="text"
                id="loginUsername"
                name="username"
            ...
            <div>
              <label htmlFor="loginPassword" className="block text-gray-700 font-medium mb-1">Password:</label>
              <input
                type="password"
                id="loginPassword"
                name="password"
            ...
            <div className="flex space-x-2">
              <button type="submit" className="bg-green-700 text-white font-semibold rounded px-4 py-2 hover:bg-green-800">
                Login
              </button>
            </div>
          </form>
