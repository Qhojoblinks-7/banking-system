...
const UserAccountOverview = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-sky-500">
      <div className="bg-sky p-10 rounded-lg shadow-2xl text-center max-w-2xl transform transition-all hover:scale-105">
        <img src={userProfilePic} alt="User Profile" className="w-24 h-24 rounded-full mx-auto mb-6 border-4 border-green-500 shadow-2xl" />
        <h2 className="text-2xl font-extrabold text-green-700 mb-4">{userData.full_name}</h2>
        ...
        <button
          className="bg-green-700 text-white py-3 px-8 rounded-lg hover:bg-green-500 shadow-md transition duration-300 text-lg font-semibold"
